...
### Full-Stack Developer | React & Node.js | UX + Design Background | Founder @ SimpleSeverance

Full-Stack Developer with 6+ years of experience specializing in React, with a background in graphic design that shapes how I approach every product I build. I don't just write code — I think about how it feels to use.

My work sits at the intersection of design and engineering. Before I wrote my first line of production code, I spent years as a graphic designer, which means I naturally think about typography, hierarchy, and user psychology alongside component architecture and API design. I've shipped across healthcare, environmental data, HVAC, and nonprofit — and I'm currently building [SimpleSeverance](https://www.simpleseverance.co), a SaaS platform that helps employees navigate workplace severance.
...
- **UX Engineer** — EY Design Studio
- **Full Stack Developer** — Robert Half
